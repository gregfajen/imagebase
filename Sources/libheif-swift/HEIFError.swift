...
typealias HEIFError = heif_error

extension HEIFError: Error, CustomDebugStringConvertible {
    
    public var exists: Bool { return code != heif_error_Ok }
    
    public var debugDescription: String {
        let error = "\(code)"
        let suberror = "\(subcode)"
        return "\(error) \(suberror)"
    }
    
}

extension heif_error_code: CustomDebugStringConvertible {
    
    public var debugDescription: String {
        switch self {
            case heif_error_Ok: return "OK"
            ...
            case heif_error_Invalid_input: return "Error in input file. Corrupted or invalid content"
            
            // Input file type is not supported.
            case heif_error_Unsupported_filetype: return "Input file type is not supported"
            
            // Image requires an unsupported decoder feature.
            case heif_error_Unsupported_feature: return "Image requires an unsupported decoder feature"
            
            case heif_error_Usage_error: return "Library API has been used in an invalid way."
            
            // Could not allocate enough memory.
            case heif_error_Memory_allocation_error: return "Could not allocate enough memory"
            
            // The decoder plugin generated an error
            case heif_error_Decoder_plugin_error: return "The decoder plugin generated an error"
            
            // The encoder plugin generated an error
            case heif_error_Encoder_plugin_error: return "The encoder plugin generated an error"
            
            // Error during encoding or when writing to the output
            case heif_error_Encoding_error: return "Error during encoding or when writing to the output"
...
extension heif_suberror_code: CustomDebugStringConvertible {
    
    public var debugDescription: String {
        switch self {
            case heif_suberror_Null_pointer_argument: return "An API argument was given a NULL pointer, which is not allowed for that function."
